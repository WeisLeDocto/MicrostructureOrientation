...
if __name__ == '__main__':
    ...
    plt.savefig('/home/weis/Codes/MicrostructureOrientation/'
                'figures/7LX1_3/image.svg', dpi=300)
    ...
    plt.savefig('/home/weis/Codes/MicrostructureOrientation/'
                'figures/7LX1_3/kernel_0.svg', dpi=300)
    ...
    plt.savefig('/home/weis/Codes/MicrostructureOrientation/'
                'figures/7LX1_3/kernel_90.svg', dpi=300)
    ...
    plt.savefig('/home/weis/Codes/MicrostructureOrientation/'
                'figures/7LX1_3/gabor_0.svg', dpi=300)
    ...
    plt.plot(np.linspace(0, 180, NB_ANGLES),
             periodic_gauss(np.linspace(0, np.pi, NB_ANGLES),
                            param[215, 591, 2], param[215, 591, 3], None, None,
                            None, None, param[215, 591, 6],
                            np.radians(angles[215, 591, 1]), None, None,
                            1),
             label='Separate fits', color='k', linestyle='--',
             alpha=0.5)
    plt.vlines(angles[215, 591, 0],
               np.min(res[215, 591]),
               res[215, 591, int(round(angles[215, 591, 0] * 44 / 180, 0))],
               color='grey', alpha=0.5)
    plt.vlines(angles[215, 591, 1],
               np.min(res[215, 591]),
               res[215, 591, int(round(angles[215, 591, 1] * 44 / 180, 0))],
               color='grey', alpha=0.5, label='Identified angles')
    plt.xlabel('Angle (degrees)')
    plt.legend()

    plt.savefig('/home/weis/Codes/MicrostructureOrientation/'
                'figures/7LX1_3/gaussian_fit.svg', dpi=300)
    ...
    plt.savefig('/home/weis/Codes/MicrostructureOrientation/'
                'figures/7LX1_3/std.svg', dpi=300)
    ...
    plt.savefig('/home/weis/Codes/MicrostructureOrientation/'
                'figures/7LX1_3/amplitude.svg', dpi=300)
