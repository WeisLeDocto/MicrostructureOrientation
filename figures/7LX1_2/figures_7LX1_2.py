...
if __name__ == '__main__':
    ...
    plt.savefig('/home/weis/Codes/MicrostructureOrientation/'
                'figures/7LX1_2/image.svg', dpi=300)
    ...
    plt.savefig('/home/weis/Codes/MicrostructureOrientation/'
                'figures/7LX1_2/kernel_0.svg', dpi=300)
    ...
    plt.savefig('/home/weis/Codes/MicrostructureOrientation/'
                'figures/7LX1_2/kernel_90.svg', dpi=300)
    ...
    plt.savefig('/home/weis/Codes/MicrostructureOrientation/'
                'figures/7LX1_2/gabor_0.svg', dpi=300)
    ...
    plt.savefig('/home/weis/Codes/MicrostructureOrientation/'
                'figures/7LX1_2/gabor_90.svg', dpi=300)

    plt.figure()
    plt.plot(np.linspace(0, 180, NB_ANGLES), res[95, 1102])
    plt.xlabel('Angle (degrees)')
    plt.ylabel('Filter response')

    plt.savefig('/home/weis/Codes/MicrostructureOrientation/'
                'figures/7LX1_2/angle_distribution.svg', dpi=300)
    ...
    plt.savefig('/home/weis/Codes/MicrostructureOrientation/'
                'figures/7LX1_2/dominant_angle.svg', dpi=300)
    ...
    plt.savefig('/home/weis/Codes/MicrostructureOrientation/'
                'figures/7LX1_2/second_angle.svg', dpi=300)
    ...
    plt.plot(np.linspace(0, 180, NB_ANGLES),
             periodic_gauss(np.linspace(0, np.pi, NB_ANGLES),
                            *param[95, 1102],
                            *np.radians(angles[95, 1102]),
                            n_peaks[95, 1102]),
             label='Gaussian interpolation', color='k')
    plt.plot(np.linspace(0, 180, NB_ANGLES),
             periodic_gauss(np.linspace(0, np.pi, NB_ANGLES),
                            *param[95, 1102],
                            *np.radians(angles[95, 1102]),
    ...
    plt.plot(np.linspace(0, 180, NB_ANGLES),
             periodic_gauss(np.linspace(0, np.pi, NB_ANGLES),
                            param[95, 1102, 2], param[95, 1102, 3], None, None,
                            None, None, param[95, 1102, 6],
                            np.radians(angles[95, 1102, 1]), None, None,
                            1),
             label='Separate fits', color='k', linestyle='--',
             alpha=0.5)
    plt.vlines(angles[95, 1102, 0],
               np.min(res[95, 1102]),
               res[95, 1102, int(round(angles[95, 1102, 0] * 44 / 180, 0))],
               color='grey', alpha=0.5)
    plt.vlines(angles[95, 1102, 1],
               np.min(res[95, 1102]),
               res[95, 1102, int(round(angles[95, 1102, 1] * 44 / 180, 0))],
               color='grey', alpha=0.5, label='Identified angles')
    plt.xlabel('Angle (degrees)')
    plt.legend()

    plt.savefig('/home/weis/Codes/MicrostructureOrientation/'
                'figures/7LX1_2/gaussian_fit.svg', dpi=300)
    ...
    plt.savefig('/home/weis/Codes/MicrostructureOrientation/'
                'figures/7LX1_2/std.svg', dpi=300)
    ...
    plt.savefig('/home/weis/Codes/MicrostructureOrientation/'
                'figures/7LX1_2/amplitude.svg', dpi=300)
    ...
    plt.savefig('/home/weis/Codes/MicrostructureOrientation/'
                'figures/7LX1_2/anisotropy.svg', dpi=300)
