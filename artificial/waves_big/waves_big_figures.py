...
if __name__ == '__main__':
    ...
    plt.savefig('/home/weis/Codes/MicrostructureOrientation/'
                'artificial/waves_big/image.svg', dpi=300)
    ...
    plt.savefig('/home/weis/Codes/MicrostructureOrientation/'
                'artificial/waves_big/dominant_angle.svg', dpi=300)
    ...
    plt.savefig('/home/weis/Codes/MicrostructureOrientation/'
                'artificial/waves_big/second_angle.svg', dpi=300)
    ...
    plt.savefig('/home/weis/Codes/MicrostructureOrientation/'
                'artificial/waves_big/std.svg', dpi=300)
    ...
    plt.savefig('/home/weis/Codes/MicrostructureOrientation/'
                'artificial/waves_big/intensity_indicator.svg', dpi=300)
    ...
    plt.savefig('/home/weis/Codes/MicrostructureOrientation/'
                'artificial/waves_big/angle_histogram.svg', dpi=300)

    fig = plt.figure(figsize=(12, 6))
    plt.subplot(131)
    plt.title('A')
    plt.ylim((0.1, 0.9))
    plt.plot(np.linspace(0, 180, NB_ANGLES), res[502, 532])
    plt.vlines(angles[502, 532, 0],
               res[502, 532, int(round(angles[502, 532, 0] * 44 / 180, 0))]
               - 0.07,
               res[502, 532, int(round(angles[502, 532, 0] * 44 / 180, 0))]
               + 0.07,
               color='k', alpha=0.5)
    ...
    plt.ylim((0.1, 0.9))
    plt.yticks([])
    plt.plot(np.linspace(0, 180, NB_ANGLES), res[146, 532])
    plt.vlines(angles[146, 532, 0],
               res[146, 532, int(round(angles[146, 532, 0] * 44 / 180, 0))]
               - 0.07,
               res[146, 532, int(round(angles[146, 532, 0] * 44 / 180, 0))]
               + 0.07,
               color='k', alpha=0.5)
    ...
    plt.ylim((0.1, 0.9))
    plt.yticks([])
    plt.plot(np.linspace(0, 180, NB_ANGLES), res[910, 532],
             label='Angular response')
    plt.vlines(angles[910, 532, 0],
               res[910, 532, int(round(angles[910, 532, 0] * 44 / 180, 0))]
               - 0.07,
               res[910, 532, int(round(angles[910, 532, 0] * 44 / 180, 0))]
               + 0.07,
               color='k', alpha=0.5)
    plt.vlines(angles[910, 532, 1],
               res[910, 532, int(round(angles[910, 532, 1] * 44 / 180, 0))]
               - 0.07,
               res[910, 532, int(round(angles[910, 532, 1] * 44 / 180, 0))]
               + 0.07,
    ...
    plt.savefig('/home/weis/Codes/MicrostructureOrientation/'
                'artificial/waves_big/angular_distributions.svg', dpi=300)
