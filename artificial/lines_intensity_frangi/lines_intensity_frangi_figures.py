...
if __name__ == '__main__':
    ...
    plt.savefig('/home/weis/Codes/MicrostructureOrientation/'
                'artificial/lines_intensity_frangi/image.svg', dpi=300)
    ...
    plt.savefig('/home/weis/Codes/MicrostructureOrientation/'
                'artificial/lines_intensity_frangi/dominant_angle.svg',
                dpi=300)
    ...
    plt.savefig('/home/weis/Codes/MicrostructureOrientation/'
                'artificial/lines_intensity_frangi/vesselness.svg',
                dpi=300)
