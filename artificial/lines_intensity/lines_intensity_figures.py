...
if __name__ == '__main__':
    ...
    low_thresh = np.percentile(amp, 5, axis=(0, 1))[np.newaxis, np.newaxis, :]
    ...
    plt.savefig('/home/weis/Codes/MicrostructureOrientation/'
                'artificial/lines_intensity/anisotropy.svg', dpi=300)
    ...
    plt.savefig('/home/weis/Codes/MicrostructureOrientation/'
                'artificial/lines_intensity/layer_score_1.svg', dpi=300)
    ...
    plt.savefig('/home/weis/Codes/MicrostructureOrientation/'
                'artificial/lines_intensity/layer_score_2.svg', dpi=300)
