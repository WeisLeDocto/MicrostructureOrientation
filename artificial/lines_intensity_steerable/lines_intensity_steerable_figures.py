...
if __name__ == '__main__':
    ...
    plt.savefig('/home/weis/Codes/MicrostructureOrientation/'
                'artificial/lines_intensity_steerable/image.svg', dpi=300)
    ...
    plt.savefig('/home/weis/Codes/MicrostructureOrientation/'
                'artificial/lines_intensity_steerable/dominant_angle.svg',
                dpi=300)
    ...
    plt.savefig('/home/weis/Codes/MicrostructureOrientation/'
                'artificial/lines_intensity_steerable/second_angle.svg',
                dpi=300)
    ...
    plt.savefig('/home/weis/Codes/MicrostructureOrientation/'
                'artificial/lines_intensity_steerable/std.svg', dpi=300)
    ...
    plt.savefig('/home/weis/Codes/MicrostructureOrientation/'
                'artificial/lines_intensity_steerable/amplitude.svg',
                dpi=300)
    ...
    plt.savefig('/home/weis/Codes/MicrostructureOrientation/'
                'artificial/lines_intensity_steerable/angle_histogram.svg',
                dpi=300)
    ...
    plt.savefig('/home/weis/Codes/MicrostructureOrientation/'
                'artificial/lines_intensity_steerable/'
                'angular_distributions.svg',
                dpi=300)
