...
if __name__ == '__main__':
    ...
    plt.savefig('/home/weis/Codes/MicrostructureOrientation/'
                'artificial/lines_intensity_congruency/image.svg', dpi=300)
    ...
    plt.savefig('/home/weis/Codes/MicrostructureOrientation/'
                'artificial/lines_intensity_congruency/dominant_angle.svg',
                dpi=300)
    ...
    plt.savefig('/home/weis/Codes/MicrostructureOrientation/'
                'artificial/lines_intensity_congruency/'
                'fractional_anisotropy.svg',
                dpi=300)
