...
if __name__ == '__main__':
    ...
    plt.savefig('/home/weis/Codes/MicrostructureOrientation/'
                'artificial/cross_congruency/image.svg', dpi=300)
    ...
    plt.savefig('/home/weis/Codes/MicrostructureOrientation/'
                'artificial/cross_congruency/image_close.svg', dpi=300)
    ...
    plt.savefig('/home/weis/Codes/MicrostructureOrientation/'
                'artificial/cross_congruency/dominant_angle.svg', dpi=300)

    plt.figure()
    plt.imshow(angle[450:550, 450:550], cmap='twilight', clim=(0, 180))
    plt.xticks([])
    plt.yticks([])
    plt.colorbar(label='Angle (degrees)')

    plt.savefig('/home/weis/Codes/MicrostructureOrientation/'
                'artificial/cross_congruency/dominant_angle_close.svg',
                dpi=300)
    ...
    plt.savefig('/home/weis/Codes/MicrostructureOrientation/'
                'artificial/cross_congruency/fractional_anisotropy.svg',
                dpi=300)
    ...
    plt.savefig('/home/weis/Codes/MicrostructureOrientation/'
                'artificial/cross_congruency/fractional_anisotropy_close.svg',
                dpi=300)
